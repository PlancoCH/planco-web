  ...
  return (
    <PageContainer>
      ...
      <div className="bg-beige-50 rounded-2xl border border-beige-300 p-8 shadow-sm">
        <h2 className="font-serif text-xl text-forest-800 mb-2">Scan QR Code</h2>
        ...
        {scanning && mappingKey && (
          <div className="mt-6 p-4 bg-forest-50 rounded-xl border border-forest-200">
            <div className="flex items-center gap-2 mb-1">
              ...
              <p className="text-xs text-forest-400 uppercase tracking-wide">Scanned Key</p>
            </div>
            <p className="text-sm font-mono text-forest-700 truncate">{mappingKey}</p>
            <button
              type="button"
