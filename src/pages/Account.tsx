...
export default function Account() {
  ...
  const handlePasswordChange = async (e: FormEvent) => {
    ...
    try {
      await updateAccount({ password, password_confirmation: passwordConfirmation });
      setPassword('');
        ...
        <div className="max-w-lg mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-forest-500 text-lg leading-relaxed">
              Manage your profile, update your password, or sign out.
            </p>
          </div>
          ...
          <div className="bg-beige-50 rounded-2xl border border-beige-300 p-8 shadow-sm mb-6">
            <h2 className="font-serif text-xl text-forest-800 mb-6">Profile Information</h2>
            <form onSubmit={handleProfileUpdate} className="space-y-4">
              <div>
                <label htmlFor="account-name" className="block text-sm font-medium text-forest-700 mb-1.5">
                  Name
                </label>
                <input
                  id="account-name"
              ...
              <div>
                <label htmlFor="account-email" className="block text-sm font-medium text-forest-700 mb-1.5">
                  Email
                </label>
                <input
                  id="account-email"
          ...
          <div className="bg-beige-50 rounded-2xl border border-beige-300 p-8 shadow-sm mb-6">
            <h2 className="font-serif text-xl text-forest-800 mb-6">Change Password</h2>
            <form onSubmit={handlePasswordChange} className="space-y-4">
              <div>
                <label htmlFor="account-password" className="block text-sm font-medium text-forest-700 mb-1.5">
                  New Password
                </label>
                <input
                  id="account-password"
              ...
              <div>
                <label htmlFor="account-password-confirmation" className="block text-sm font-medium text-forest-700 mb-1.5">
